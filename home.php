          ...
          <div id="slider-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <div class="col-sm-6">
                  <h1><span><?php echo $lang['E'];?></span><?php echo $lang['SHOPPER'];?></h1>
                  <h2><?php echo $lang['FREE_ECOM'];?></h2>
                  <p><?php echo $lang['TEXTO_PRUEBA'];?> </p>
              ...
              <div class="item">
                <div class="col-sm-6">
                  <h1><span><?php echo $lang['E'];?></span><?php echo $lang['SHOPPER'];?></h1>
                  <h2><?php echo $lang['RESPONSIVE_DESIGN'];?></h2>
                  <p><?php echo $lang['TEXTO_PRUEBA'];?> </p>
              ...
              <div class="item">
                <div class="col-sm-6">
                  <h1><span><?php echo $lang['E'];?></span><?php echo $lang['SHOPPER'];?></h1>
                  <h2><?php echo $lang['Free_ecomenser'];?></h2>
                  <p><?php echo $lang['TEXTO_PRUEBA'];?></p>
      ...
      <div class="row">
        ...
        <div class="col-sm-9 padding-right">
          <div class="features_items"><!--features_items-->
            <h2 class="title text-center"><?php echo $lang['Featured_items']; ?></h2>
              ...
              <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                      ...
                      <button type="submit" name="btnorder" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>
                       <?php echo $lang['ADD_TO_CART']; ?></button>
                    </div>
       ...
       <?php  } ?>
          ...
          <div class="recommended_items"><!--recommended_items-->
            <h2 class="title text-center"><?php echo $lang['RECOMMENDED_ITEMS'];?></h2>
                    ...
                    <div class="product-image-wrapper">
                      <div class="single-products">
                        <div class="productinfo text-center">
                          ...
                          <h2>&#36 <?php  echo $result->PRODISPRICE; ?></h2>
                          <p><?php  echo    $result->PRODESC; ?></p>
                           <button type="submit" name="btnorder" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i> <?php echo $lang['ADD_TO_CART']; ?></button>
                        </div>
