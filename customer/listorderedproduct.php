...
?>
 	 <h4><?php echo $lang['YOUR_ORDER_HAS_BEEN'];?></h4><br/>
		<h5><?php echo $lang['DEAR'];?></h5>
		<h5><?php echo $lang['CASH'];?></h5>
		 <hr/>
		 <h4><strong><?php echo $lang['PICK_INFO'];?></strong></h4>
		 <div class="row">
		 	<!-- <div class="col-md-6">
...
?>
 	 <h4><?php echo $lang['YOUR_ORDER_HAS_BEEN_DELIVERY'];?></h4><br/>
 		<h5><?php echo $lang['DEAR'];?></h5>
		<h5><?php echo $lang['DELIVERY'];?>	</h5>
		 <hr/>
		 <h4><strong><?php echo $lang['DELIVERY_INFO'];?></strong></h4>
		 <div class="row">
		 	<div class="col-md-6">
		 		<p> <?php echo $lang['ORDER_NUMBER'];?><?php echo $_SESSION['ordernumber']; ?></p>
					...
					$res = $mydb->loadResultList();
					?>
		 		<p><?php echo $lang['ITEMS_TO_DELIVER'];?> <?php
		 		foreach ( $res as $row) echo $row->countitem; ?></p>
...
?>
<hr/>
 <h4><strong><?php echo $lang['ORDER_INFORMATION'];?></strong></h4>
		...
		?>
 		...
 		<div class="row">
		  	<div class="col-md-6 pull-left">
		  	 <div><?php echo $lang['ORDER_DATE'];?><?php echo date_format(date_create($cur->ORDEREDDATE),"M/d/Y h:i:s"); ?></div>
		  		<div><?php echo $lang['PAYMENT_METHOD'];?><?php echo $cur->PAYMENTMETHOD; ?></div>
		  ...
		  ?>
		   <hr/>
		  <div class="row">
		 		 <p><?php echo $lang['PLEASE_PRINT'];?></p><br/>
		  	  <p><?php echo $lang['TY'];?></p>
		  	  <p><?php echo $lang['SINCERELY'];?></p>
