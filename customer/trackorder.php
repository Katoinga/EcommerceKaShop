      ...
      <div class="col-sm-3">
          ...
          <ul class="list-group">
            ...
            <!-- <li class="list-group-item text-muted">Profile</li> -->
             <li class="list-group-item text-right"><span class="pull-left"><strong><?php echo $lang['REAL_NAME'];?></strong></span> <?php echo $singlecustomer->FNAME .' '.$singlecustomer->LNAME; ?> </li>
            <li class="list-group-item text-right"><span class="pull-left"><strong><?php echo $lang['JOINED'];?></strong></span><?php echo date_format(date_create($singlecustomer->DATEJOIN),'M. d, y');?></li>
...
<div class="panel-header">
  <h2><?php echo $lang['TRACKING_ORDER'];?> <SMALL><a href="<?php echo web_root; ?>index.php?q=profile" class="btn btn-sm btn-primary"><i class="fa  fa-chevron-left"></i> Back</a></SMALL></h2>
</div>          
  <div class="panel-body">
      ...
      <div class="table-responsive" style="margin-top:5%;"> 
             <form action="customer/controller.php?action=delete" Method="POST">            
                    <table id="" class="table"  style="font-size:12px" cellspacing="0"  > 
                      <thead>
                        <tr> 
                          <th align="center"><?php echo $lang['PROCESSING'];?> </th>
                          <th></th>  
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title" id="myModalLabel"><?php echo $lang['CHOOSE_IMAGE'];?></h4>
                </div>
                ...
                "post">
                  ...
                  <div class="modal-footer">
                    ...
                    name="savephoto" type="submit"><?php echo $lang['UPLOAD_IMAGE'];?></button>
                  </div>
                </form>
              </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
