             ...
             <form   method="POST" action="<?php echo web_root ; ?>cart/controller.php?action=add">           
                    ...
                    <tbody>
                        ...
                        foreach ($cur as $result) { 
                          ...
                          <td>
                          <p><h4><?php echo $lang['DATE_ADED'];?> <?php echo date_format(date_create($result->WISHDATE),"M/d/Y h:i:s") ; ?></h4></p>
                          <p><h2><?php echo  $result->CATEGORIES; ?></h2></p> 
                          <p><h4><?php echo $lang['PRODUCT_DESCRIPTION'];?></h4></p>
                          <ul> 
                            <li><?php echo  $result->PRODESC; ?></li> 
                          </ul>
                          <p><h5><?php echo $lang['PRICE'];?><?php echo  $result->PROPRICE; ?></h5></p>
                          <?php
                            if ($result->PRODISCOUNT>0){
                           ?>
                            <p><h5><?php echo $lang['DISCOUNT'];?> <?php echo  $result->PRODISCOUNT; ?></h5></p>
                            <p><h5><?php echo $lang['DISCOUNTED'];?><?php echo  $result->PRODISPRICE; ?></h5></p> 
                          <?php } ?>
                        <input type="hidden" name="PROPRICE" value="<?php  echo $result->PRODISPRICE; ?>">
                        <input type="hidden" name="PROID" value="<?php  echo $result->PROID; ?>">
                       <button  type="submit"  class="btn btn-primary btn-sm"  name="btnorder"><?php echo $lang['ORDER_NOW'];?></button>
