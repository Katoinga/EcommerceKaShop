    ...
    <div class="col-sm-3">
        <div class="panel">
            ...
            <!-- <li class="list-group-item text-muted">Profile</li> -->
                ...
                "pull-left"><strong><?php echo $lang['REAL_NAME'];?></strong></span>
                <?php echo $res->FNAME .' '.$res->LNAME; ?></li>
                <li class="list-group-item text-right">
                <div class="panel-group" id="accordion">
                  <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"  ><?php echo $lang['CHANGE_PASS'];?></a>
        ...
        <div class="panel">
            <div class="panel-body">
                <ul class="nav nav-tabs" id="myTab">
                    <li class="active">
                        <a data-toggle="tab" href="#home"><?php echo $lang['LIST_OF_ORDERS'];?></a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#settings"><?php echo $lang['UPDATE_ACCOUNT'];?></a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#wishlist"><?php echo $lang['WISHLIST'];?></a>
                    </li>
                </ul>
                        ...
                        <div class="table-responsive" style="margin-top:5%;">
                                ...
                                id="example" style="font-size:12px">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="150px"><?php echo $lang['REMARKS'];?></th>
                                            <th></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                            ...
                            <a href="#"  title="View list Of ordered products"  class="orderid   "  data-target="#myOrdered" data-toggle="modal" data-id="<?php echo  $result->ORDEREDNUM; ?>"><i class="fa fa-info-circle fa-fw"></i> view orders</a>
                                            ...
                                            <td class="tooltip-demo">
                                                ...
                                                "tooltip tooltip.top"><?php echo $lang['VIEW'];?></span></a>
            ...
            <div class="modal-content">
                ...
                "multipart/form-data" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        "btn btn-pup" name="savephoto" type="submit"><?php echo $lang['UPLOAD_IMAGE'];?></button>
                    </div>
                </form>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
