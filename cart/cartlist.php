    ...
    <div class="col-md-12 col-sm-8 content">
        <div class="row">
            <div class="col-md-12">
                              ...
                              <form id="form" action="cart/controller.php?action=edit" method="POST"
                                  ...
                                  <div class="column4">
                                    ...
                                    <div class="form-inline" style="float: left; width:190px">
                                        ...
                                        <!-- END -->
                                        <a href="cart/controller.php?action=delete&id=<?php echo $result->PRODUCTID; ?>" class="btn btn-link"   ><?php echo $lang['REMOVE'];?></a>
                                        <button type="submit" name="update" class="btn btn-link" ><?php echo $lang['UPDAT'];?></button>
                                     </div>
                ...
                <a href="index.php?page=2" class="btn btn-default pull-left"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;<strong><?php echo $lang['ADD_NEW_ORDER'];?></strong></a>
                <a href="index.php?page=7" name="proceed"  class="btn btn_fixnmix pull-right"   ><strong><?php echo $lang['PROCEED'];?></strong> <span class="glyphicon glyphicon-chevron-right"></span></a>
