...
?>
 ...
 <div class="row">
         <div class="col-lg-12">
            <h1 class="page-header"><?php echo $lang['ADD_NEW_PRODUCT'];?></h1>
          </div>
          <!-- /.col-lg-12 -->
       </div>
              ...
              <div class="form-group">
                    <div class="col-md-8">
                      ...
                      "OWNERNAME"><?php echo $lang['OWNER:'];?></label>
                   ...
                   <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "OWNERPHONE"><?php echo $lang['PHONE:'];?></label>
                 ...
                 <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "PRODESC"><?php echo $lang['DESCRIPTION'];?></label>
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "ORIGINALPRICE"><?php echo $lang['ORIGINAL_PRICE:'];?></label>
                      ...
                      "PROPRICE"><?php echo $lang['PRICE'];?></label>
