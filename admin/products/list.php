...
<?php
		...
		<div class="row">
       	 <div class="col-lg-12">
            <h1 class="page-header"><?php echo $lang['LIST_OF_PRODUCTS'];?><a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> New</a>  </h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
				...
				<table id="dash-table"  class="table table-striped table-bordered table-hover "  style="font-size:12px" cellspacing="0" >
				  ...
				  <thead>
				  	<tr>
				  		<th width="1%">#</th>
				  		<th width="50"><?php echo $lang['IMAGE'];?></th>
				  		<!-- <th>Model</th>  -->
				  		...
				  		<th><?php echo $lang['DISCOUNTED'];?></th>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel"><?php echo $lang['IMAGE'];?></h4>
                                </div>
                                ...
                                "post">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        "button"><?php echo $lang['CLOSE'];?></button> <button class="btn btn-primary"
