...
<div class="container">
	...
	<div class="row">
		...
		<h3><?php echo $lang['DATE_FILTER_:'];?></h3>
		</div>
		 <div class="form-group">
...
<span id="printout">
<div class="row" ><h3 align="center"><?php echo $lang['OVERALL_INCOME_IN'];?> <?php echo ((@$_POST['start']) ? $_POST['start'] : '') . ' to ' .  ((@$_POST['end']) ? $_POST['end'] : '');?></h3></div>
<table  class="table table-bordered" cellspacing="0">
<thead>
<tr bgcolor="#bbd43b">
<td ><strong><?php echo $lang['NAME'];?></strong></td>
<td ><strong><?php echo $lang['ORDER_NUMBER'];?></strong></td>
<td ><strong><?php echo $lang['DATE_ORDERED'];?></strong></td>
...
<tr> <h4 align="right"> <?php echo $lang['OVERALL_PRICE_:'];?> &#36 <?php echo isset( $overall) ? $overall : 0; ?></h4>  </tr>

</tfoot>
</table>
</span>
<button onclick="tablePrint();" class="btn btn_fixnmix"><span class="glyphicon glyphicon-print"></span> <?php echo $lang['PRINT_REPORT'];?></button>
