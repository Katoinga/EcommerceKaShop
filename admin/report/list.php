 	    ...
 	    <div class="row">
		  <div class="col-md-12">
			 <div class="form-group input-group" style="margin-top:25px;">
                <button class="btn btn-primary btn-sm" name="submit" type="submit" ><?php echo $lang['SEARCH'];?> <i class="fa fa-search"></i>
                </button>
            </div>
		   </div>
	    </div>
...
<span id="printout">
	<div class="col-md-12" >
	<div class="page-header" style="text-align:center;" ><h1><?php echo $lang['LIST_OF_ORDERED_PRODUCTS'];?></h1>
		<div><?php echo $lang['INCLUSIVE_DATES:_FROM_:'];?> <?php echo isset($_POST['date_pickerfrom']) ? $_POST['date_pickerfrom'] :'';?> <?php echo $lang['-_TO_:'];?> <?php echo isset($_POST['date_pickerto']) ? $_POST['date_pickerto'] : '';?> </div>
	</div>
...
<form class="" method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>">
		...
		<thead>
			<tr bgcolor="skyblue" style="font-weight: bold;">
				<td ><?php echo $lang['DATE_ORDERED'];?></td>
				<!-- <td >Customer</td> -->
				<td ><?php echo $lang['PRODUCT'];?></td>
				<td ><?php echo $lang['ORIGINAL_PRICE'];?></td>
...
<tfoot>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="col-md-2">
			<button onclick="tablePrint();" class="btn btn-primary"><i class="fa fa-print"></i> <?php echo $lang['PRINT_REPORT'];?></button>
 		</div>
	  </div>
	</div>
</div>
