...
?>
 ...
 <form class="form-horizontal span6" action="controller.php?action=edit" method="POST">
          ...
          <fieldset>
            <legend> <?php echo $lang['UPDATE_USER_ACCOUNT'];?></legend>
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                       <select class="form-control input-sm" name="U_ROLE" id="U_ROLE">
                          <option value="Administrator"  <?php echo ($singleuser->U_ROLE=='Administrator') ? 'selected="true"': '' ; ?>><?php echo $lang['ADMINISTRATOR'];?></option>
                          <option value="Staff" <?php echo ($singleuser->U_ROLE=='Staff') ? 'selected="true"': '' ; ?>><?php echo $lang['STAFF'];?></option>
                          <!-- <option value="Customer">Customer</option> -->
                          <option value="Encoder" <?php echo ($singleuser->U_ROLE=='Encoder') ? 'selected="true"': '' ; ?>><?php echo $lang['ENCODER'];?></option>
                        </select>
                      </div>
                    </div>
                  </div>
             ...
             <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         <button class="btn btn-primary " name="save" type="submit" ><span class="fa fa-save fw-fa"></span> <?php echo $lang['SAVE'];?></button>
