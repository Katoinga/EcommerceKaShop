...
<div class="row">
       	 <div class="col-lg-12">
            <h1 class="page-header"><?php echo $lang['LIST_OF_USERS'];?>  <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> New</a>  </h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
