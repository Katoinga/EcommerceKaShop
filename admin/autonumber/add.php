...
?>
 <form class="form-horizontal span6" action="controller.php?action=add" method="POST">
           ...
           <div class="row">
         <div class="col-lg-12">
            <h1 class="page-header"><?php echo $lang['ADD_NEW_AUTONUMBER'];?></h1>
          </div>
          <!-- /.col-lg-12 -->
       </div>
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      "AUTOSTART"><?php echo $lang['START'];?></label>
                    ...
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "AUTOINC"><?php echo $lang['INC'];?></label>
                   ...
                   <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "AUTOEND"><?php echo $lang['END'];?></label>
                    ...
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "AUTOKEY"><?php echo $lang['KEY'];?></label>
