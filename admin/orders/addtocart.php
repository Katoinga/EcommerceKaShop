      ...
      <div class="">
        <div class="panel panel-default">
          <div class="panel-body">
            <fieldset>
              <legend><h2 class="text-left"><?php echo $lang['CART_LIST'];?></h2></legend>
           ...
           <tfoot  >
                ...
                <a href="index.php?view=addorder" class="btn btn-default"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;<strong><?php echo $lang['ADD_ANOTHER_PRODUCTS'];?></strong></a>
               <button type="submit" name="proceed" class="btn btn_fixnmix pull-right"   ><strong><?php echo $lang['PROCEED_AND_CHECKOUT'];?></strong> <span class="glyphicon glyphicon-chevron-right"></span></button>
            </form>
       </fieldset>
          </div>
        </div>
