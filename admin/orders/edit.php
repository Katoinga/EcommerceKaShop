  ...
  <script>
    ...
    <!--/span-->
       ...
       <form class="form-horizontal span6" action="controller.php?action=edit" method="POST"  />
          ...
          <fieldset>
            <legend><?php echo $lang['NEW_PRODUCTS'];?></legend>
             ...
             <div class="container">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                      ...
                      "PRODUCTNAME"><?php echo $lang['NAME'];?></label>
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      <label class="col-md-3 control-label" for=
                      "PRODUCTTYPE"><?php echo $lang['TYPE'];?></label>
                   ...
                   <div class="form-group">
                    <div class="col-md-12">
                      <label class="col-md-3 control-label" for=
                      "ORIGIN"><?php echo $lang['ORIGIN'];?></label>

                      <div class="col-md-8">
                       <select class="form-control input-sm" name="ORIGIN" id="ORIGIN">
                          <option value="None"><?php echo $lang['SELECT_ORIGIN'];?></option>
                          <?php
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      <label class="col-md-3 control-label" for=
                      "CATEGORY"><?php echo $lang['CATEGORY'];?></label>
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      <label class="col-md-3 control-label" for=
                      "QTY"><?php echo $lang['QUANTITY'];?></label>
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      <label class="col-md-3 control-label" for=
                      "PRICE"><?php echo $lang['PRICE'];?></label>
                   ...
                   <div class="form-group">
                    <div class="col-md-12">
                      <label class="col-md-3 control-label" for=
                      "DESCRIPTION"><?php echo $lang['DESCRIPTION'];?></label>
             ...
             <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div class="col-md-8">
                        <button class="btn btn-btn_fixnmix" name="save" type="submit" ><?php echo $lang['SAVE'];?></button>
                      </div>
                    </div>
                  </div>
                  </div>
    ...
    <footer>
        <p><?php echo $lang['COMPANY_JANNO'];?></p>
    </footer>
</div>
<!--/.fluid-container-->
 </fieldset>
