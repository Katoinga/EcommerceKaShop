...
<div class="container">
  ...
  <span id="printout">
  <h3 align="center"><?php echo $lang['FIX_AND_MIX_BAKESHOP'];?></h3>
      <h4 align="center"><?php echo $lang['BLOCK_5_AR_ZAYCO_SUBDIVISION'];?><br/>
      <?php echo $lang['KABANKALAN_CITY'];?><br/>
      </h4>

              <legend><h2 class="text-left"><?php echo $lang['BILLING_DETAILS'];?></h2></legend>
   ...
   <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td> </td>
              <td><?php echo $lang['ORDER_NUMBER'];?><?php echo $_SESSION['ORDERNUMBER']; ?></td>
            ...
            <tr>
              ...
              <!--   <div class="col-md-6 pull-left">
                ...
                <div class="col-md-4 pull-right">
                  <!-- <div>Total Price : &#36 <?php echo number_format($tot,2);?></div> -->
                  <!-- <div>Delivery Fee : &#36 <?php echo number_format($price,2); ?></div> -->
                  <div>Overall Price : &#36 <?php echo number_format($cur->TOTALPRICE,2); ?></div>
                </div>
              </div>
