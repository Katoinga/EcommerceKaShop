      ...
      <div class="">
        <div class="panel panel-default">
          <div class="panel-body">
            <fieldset>
              <legend><h2 class="text-left"><?php echo $lang['ORDER_DETAILS'];?></h2></legend>

            <table class="fixnmix-table">

              <tbody>
                <tr>
                <td width="100px"><?php echo $lang['FIRST_NAME'];?></td><td  width="350px">
                ...
                <td width="100px"><?php echo $lang['LAST_NAME'];?></td><td> <input  id="LASTNAME" name="LASTNAME"  class="form-control input-sm"  type="text" value="<?php echo isset($_SESSION['LASTNAME'])? $_SESSION['LASTNAME'] : ""; ?>"></td>
                </tr>
                <tr>
                <td><?php echo $lang['ADDRESS'];?> </td><td> <input  id="ADDRESS" name="ADDRESS"  class="form-control input-sm"  type="text" value="<?php echo isset($_SESSION['ADDRESS'])? $_SESSION['ADDRESS'] : ""; ?>"></td>
                 <td  width="100px"><?php echo $lang['CONTACT_NUMBER'];?></td><td  width="350px"> <input  id="CONTACTNUMBER" name="CONTACTNUMBER"  class="form-control input-sm"  type="number" value="<?php  echo isset($_SESSION['CONTACTNUMBER'])? $_SESSION['CONTACTNUMBER'] : "";?>"></td>
              </tr>
              </tbody>
             <tfoot><tr><td></td></tr></tfoot>
              ...
              <table class="fixnmix-table" id="table">
                ...
                <tr>
                  ...
                  <th style="width:120px"><?php echo $lang['TOTAL'];?></th>
                  </tr>
                </thead>
                <tbody>
              ...
              <div class="row"> <h3  align="right" margin-right="20%">Total Price : &#36 <span  id="sum">0.00</span></h3></div>
                ...
                ?>
                 <input  id="ORDERNUMBER" name="ORDERNUMBER"   type="hidden" value="<?php echo $res->AUTO; ?>">
                  <a href="index.php?view=addtocart" class="btn btn-default"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;<strong><?php echo $lang['VIEW_CART'];?></strong></a>
                <button   name="submitorder"  id ="submitorder" class="btn btn_fixnmix pull-right"  onclick="validatedate()" ><strong><?php echo $lang['SAVE_ORDER'];?></strong> <span class="glyphicon glyphicon-chevron-right"></span></button>
