...
?>
        <form class="form-horizontal span6" action="" method="POST"  />
          <fieldset>
            <legend><?php echo $lang['ADD_NEW_ORDER'];?></legend>
          ...
          <table class="table table-hover" id="fixnmix">
              <thead>
                <tr >
                  ...
                  <th align="center"><?php echo $lang['QUANTITY'];?></th>
                  <th align="center"><?php echo $lang['PRICE'];?></th>
                  <th></th>
                </tr>
              </thead>
              <tbody>
                <?php
                  ...
                  foreach ($cur as $result) {
                    ...
                    echo '<td align="center"> &#36 '. $result->PRICE.'</td>';
                    // echo '<td align="left">
