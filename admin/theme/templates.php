        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <a class="navbar-brand"  href="<?php echo web_root; ?>admin/index.php" ><?php echo $lang['ADMIN_PANEL'];?></a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                 <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-plus fa-fw"></i> <?php echo $lang['NEW'];?>  <i class="fa fa-caret-down"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="<?php echo web_root; ?>admin/products/index.php?view=add"><i class="fa fa-barcode fa-fw"></i> <?php echo $lang['PRODUCT'];?></a>
                        </li>
                        <li><a href="<?php echo web_root; ?>admin/category/index.php?view=add"><i class="fa fa-list-alt  fa-fw"></i> <?php echo $lang['CATEGORY'];?></a>
                        </li>
                            <?php if ($_SESSION['U_ROLE']=='Administrator') {
                            # code...
                        ?>
                         <li><a href="<?php echo web_root; ?>admin/user/index.php?view=add"><i class="fa fa-user  fa-fw"></i> <?php echo $lang['USER'];?></a>
                            </li>
                        <?php }?>
...
?>
                ...
                <li class="dropdown"><div id="languages">
                <a href="index.php?lang=en"><img src="../../images/en.png" /></a>
                <a href="index.php?lang=de"><img src="../../images/de.png" /></a>
                <a href="index.php?lang=es"><img src="../../images/es.png" /></a>
                </div>
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <?php echo $lang['Greetings']; ?>, <?php echo $_SESSION['U_NAME']; ?> <img title="profile image" width="23px" height="17px" src="<?php echo web_root.'admin/user/'.$singleuser ->USERIMAGE ?>">
                    ...
                    <ul class="dropdown-menu dropdown-acnt">
                      ...
                      <li><a title="Edit" href="<?php echo web_root; ?>admin/user/index.php?view=edit&id=<?php echo $_SESSION['USERID']; ?>"  ><?php echo $lang['EDIT_MY_PROFILE'];?></a>

                        </li>
                          </li>
                           <li><a href="<?php echo web_root; ?>admin/logout.php"><i class="fa fa-sign-out fa-fw"></i> <?php echo $lang['LOG_OUT'];?></a>
                        </li>
                  </div>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <!--     <li>
                        ...
                        <li>
                             <a href="<?php echo web_root; ?>admin/products/index.php"><i class="fa fa-barcode fa-fw"></i><?php echo $lang['PRODUCTS'];?> </a>

                        </li>
                        <li>
                             <a href="<?php echo web_root; ?>admin/orders/index.php" ><i class="fa fa-reorder fa-fw"></i>  <?php echo $lang['ORDERS'];?> <?php echo $order; ?></a>
                  </li>

                         <li>
                             <a href="<?php echo web_root; ?>admin/category/index.php" ><i class="fa fa-list-alt fa-fw"></i>  <?php echo $lang['CATEGORIES'];?> </a>
                        ...
                        ?>
                         <li>
                             <a href="<?php echo web_root; ?>admin/settings/index.php" ><i class="fa fa-list-alt fa-fw"></i>  <?php echo $lang['SETTING'];?> </a>
                       ...
                       <!--   <li>
                          ...
                          <li>
                            <a href="<?php echo web_root; ?>admin/user/index.php" ><i class="fa fa-user fa-fw"></i> <?php echo $lang['USERS'];?> </a>

                        </li>
                         <li>
                            <a href="<?php echo web_root; ?>admin/report/index.php" ><i class="fa  fa-file-text fa-fw"></i> <?php echo $lang['REPORT'];?> </a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel"><?php echo $lang['PROFILE_IMAGE.'];?></h4>
                                </div>
                                ...
                                "post">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        name="savephoto" type="submit"><?php echo $lang['UPLOAD_PHOTO'];?></button>
                                    </div>
                                </form>
                            </div><!-- /.modal-content -->
                        </div><!-- /.modal-dialog -->
