    ...
    <div class="container">
      <div class="breadcrumbs">
        <ol class="breadcrumb">
          ...
          <li class="active"><?php echo $lang['SHOPING_CART'];?></li>
        </ol>
      </div>
...
?>
                         ...
                         <thead>
                          <tr class="cart_menu">
                             ...
                             <td  width="15%" ><?php echo $lang['PRICE'];?></td>
                             <td  width="15%" ><?php echo $lang['QUANTITY'];?></td>
                             <td  width="15%" ><?php echo $lang['TOTAL'];?></td>
                          </tr>
                         </thead>
             ...
             ';
                        ...
                        <h3 align="right"> <?php echo $lang['TOTAL'];?>  &#36<span id="sum">0</span></h3>
    </div>
  </div>
...
<section id="do_action">
    <div class="container">
      <div class="heading">
        <h3><?php echo $lang['WHAT_WOULD'];?></h3>
        <p><?php echo $lang['CHOOSE_IF_YOU'];?></p>
      </div>
      <div class="row">
