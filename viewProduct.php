     ...
     <div class="modal-body">
              <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <button class="btn btn-pup"  name="btnorder" type="Submit"><?php echo $lang['ORDER_NOW'];?> </button>
                    <button class="btn btn-default" id="btn_close" data-dismiss="modal" type="button"><?php echo $lang['CLOSE'];?></button>
