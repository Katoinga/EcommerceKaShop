            ...
            <div class="panel panel-default">
              <div class="panel-body">
                <div class="text-center">
                  ...
                  <h2 class="text-center"><?php echo $lang['FORGOT_PASS']; ?></h2>
                  <p><?php $lang['PUT_YOUR_CODE']; ?></p>
                  ...
                  <div class="panel-body">
                    ...
                    <form id="register-form" role="form" autocomplete="off" class="form" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <a href="index.php"><?php echo $lang['BACK_TO_SITE']; ?></a>
                      </div>
...
<div class="container">
	<div class="row">
      ...
      <h2 class="text-center"><?php echo $lang['PASSWORD_CHANGED']; ?></h2>
          	<br><br> <a href="index.php"><?php echo $lang['BACK_TO_SITE']; ?></a>
          </div>
	</div>
<?php  }else{ ?>
<div class="container">
                ...
                <div class="text-center">
                  ...
                  <div class="panel-body">
                    ...
                    <form id="register-form" role="form" autocomplete="off" class="form" method="post">
                      ...
                      <div class="form-group">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-phone color-blue"></i> +51</span>
